...
const Exprence = () => {
    return (
        <div className=" px-4 mb-9">
           ...
           <h1 className="text-center  items-center text-2xl font-bold text-green-500 mt-4 mb-5 "> My Expence</h1>

<div className=" grid lg:grid-cols-3 mx-auto w-full grid-cols-1 ">

  <div data-aos="fade-right">

 
<div className="card w-[340px]  bg-base-300 border-[5px]">
